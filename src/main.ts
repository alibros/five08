...
import {componentSvg,cutoutSvg,esc,finishSwatchSvg,mountingSvg,panelFinishDefs,panelFinishSurface,rackContextSvg,screwsSvg,templateSvg,thumbnailSvg} from './svg';
...
function exportableSvg(kind:'art'|'cut'|'vcv'){
  ...
  svg.querySelectorAll('.design-guide,.selection-ui,.empty-panel,#smart-guide-layer,#marquee,.panel-texture,.screw').forEach(n=>n.remove());
