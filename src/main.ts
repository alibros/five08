...
import {componentSvg,cutoutSvg,esc,mountingSvg,panelFinishDefs,panelFinishSurface,rackContextSvg,templateSvg} from './svg';
...
function partThumbnail(r:string,color:string,orientation?:string,id=''){const common=`stroke="#343831" stroke-width="1.5"`;let s='';
